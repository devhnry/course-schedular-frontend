...
import { type LoginInput, type OtpInput, otpSchema } from "../schemas/authSchema"
import { AuthStatusCode, type LoginResponse, type LogoutResponse } from "../types/auth.ts"
...
export function useLogin() {
    ...
    const verifyOtp = async (data: OtpInput): Promise<{ status: "success" | "failed" | null; role?: string }> => {
